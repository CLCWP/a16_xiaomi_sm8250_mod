...
local_version_date_str="-clcwpwqi-$(date +%Y%m%d)-${GIT_COMMIT_ID}"
...
if [ $KSU_ENABLE -eq 1 ]; then
    ...
    wget https://github.com/SukiSU-Ultra/SukiSU_KernelPatch_patch/releases/download/0.12.1/patch_linux
    chmod +x patch_linux
    ./patch_linux
    rm Image
    mv oImage Image
